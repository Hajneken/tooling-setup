...
# FIND ALL SETTINGS in https://github.com/Hajneken/tooling-setup/blob/main/.dotfiles/.zshrc
...
plugins=(git nvm zsh-syntax-highlighting zsh-autosuggestions oc)
...
__conda_setup="$('/home/hynek/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/hynek/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/hynek/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/hynek/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
